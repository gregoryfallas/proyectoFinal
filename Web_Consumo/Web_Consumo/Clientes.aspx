                                            ...
                                            <ul id="navigation">
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="submenu">
                                                        ...
                                                        <li><a href="TClientes.aspx">Clientes</a></li>
                ...
                <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div>
                                ...
                                <div class="input_field">
                                    <h4>CEDULA</h4>
                                    <input pattern="[0-9 ] {1,11} " title="Solo numeros, máximo 11" runat="server" id="inp_Cedula" class="form-control" type="text" placeholder="CEDULA">
                                </div>
                                <br />
                                <div class="input_field">
                                    <h4>NOMBRE</h4>
                                ...
                                <div class="input_field">
                                    <h4>TELEFONO</h4>
                                    <input pattern="[0-9 ] {1,11} " title="Solo numeros, máximo 9" runat="server" id="inp_Telefono" class="form-control" type="text" placeholder="TELEFONO">
                ...
                <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div>
                                <div class="input_field">
                                    <h4>IDCLIENTE</h4>
                                    <input runat="server" id="inp_Idcliente_AG" class="form-control style_disabled" type="text" placeholder="ID CLIENTE">
                                </div>
                                <br />
                                <div class="input_field">
                                    <h4>CEDULA</h4>
                                    <input pattern="[0-9 ] {1,11} " title="Solo numeros, máximo 11" runat="server" id="inp_Cedula_AG" class="form-control" type="text" placeholder="CEDULA">
                                </div>
                                <br />
                                <div class="input_field">
                                    <h4>NOMBRE</h4>
                                ...
                                <div class="input_field">
                                    <h4>TELEFONO</h4>
                                    <input pattern="[0-9 ] {1,11} " title="Solo numeros, máximo 11" runat="server" id="inp_Telefono_AG" class="form-control" type="text" placeholder="TELEFONO">
                                </div>
                                <br />
                                <div class="input_field">
                                    <h4>ID TIPO CLIENTE</h4>
