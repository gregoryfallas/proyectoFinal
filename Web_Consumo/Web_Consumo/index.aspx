<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Web_Consumo.Index" %>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        <h3>Destinos mas populares</h3>
                        <p>Conozca los destinos mas visitados por nuestros clientes</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        ...
                        <div class="content">
                            <p class="d-flex align-items-center">Francia <a href="travel_destination.html">  07 Places</a> </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        ...
                        <div class="content">
                            <p class="d-flex align-items-center">Brasil <a href="travel_destination.html">  03 Places</a> </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        ...
                        <div class="content">
                            <p class="d-flex align-items-center">Estados Unidos<a href="travel_destination.html">  10 Places</a> </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        ...
                        <div class="content">
                            <p class="d-flex align-items-center">Las Maldivas <a href="travel_destination.html">  02 Places</a> </p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="video_wrap text-center">
                        <h3>Favorito de los usuario: Bhutan</h3>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <h3>Viajes comodosy</h3>
                        <p>Disfrute de los mejores lugares viajando con la comodidad que ofrece Travelo</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <p>Nuestros paquetes cuentan con hospedaje en los mejores hoteles del mundo</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <p>Pregunte por nuestras guias para aprovechar al maximo sus vacaciones</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="img/testmonial/author.jpg" alt="">
                                        </div>
                                        <p>""Si lo que quieres es vivir una
                                            experiencia única de viaje y que sea,
                                            además, para relajarse en un ambiente
                                            exótico, no descartes la idea de hacerlo en
                                            Nepal"</p>
                        ...
                        <div class="single_carousel">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="img/testmonial/author2.jpg" alt="">
                                        </div>
                                        <p>"Brasil tiene una cultura increíble,
                                            buena comida, una maravillosa vida
                                            nocturna y fantásticos resorts de
                                            playa en Copacabana"</p>
                                        <div class="testmonial_author">
                                            <h3> Lisa Simpson</h3>
                                        </div>
                                    </div>
                        ...
                        <div class="single_carousel">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        <div class="author_thumb">
                                            <img src="img/testmonial/author3.jpg" alt="">
                                        </div>
                                        <p>Los franceses son las personas más
                                            amables del mundo; te hacen sentir
                                            bienvenido, conocen totalmente el
                                            término turista y se preocupan porque te
                                            lleves un buen sabor de boca del país"</p>
                                        <div class="testmonial_author">
                                            <h3>- Mary Stewart</h3>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_trip">
                        ...
                        <div class="info">
                            ...
                            <a href="#">
                                <h3>Yellowstone, Estados Unidos</h3>
                            </a>
                        </div>
                    </div>
                </div>
